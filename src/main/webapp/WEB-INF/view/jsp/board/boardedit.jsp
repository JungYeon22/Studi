...
<form id="boardEditForm" style="margin-top: 70px" >
    ...
    <div class="container">
        <div class="card">
            <div class="card-header bg-white">
                <div class="row">
                    <div class="col">
                        <input type="text" class="form-control" id="subject" name="SUBJECT" placeholder="제목" value="${boardDTO.SUBJECT}" >
                        ...
                        <div class="hstack gap-3">
                            <input type="number" class="form-control p-2" id="userTotCnt" name="userTotCnt" placeholder="모집인원" min="2" max="5" value="${boardDTO.userTotCnt}" readonly>
                    ...
                    <div id="button">
                        <button type="button" id="boardEditFormBtn" class="btn btn-primary">글수정</button>
                    </div>
                </div>
            </div>
            <div class="card-body">
...
<script src="${pageContext.request.contextPath}/js/board/boardEdit.js"></script>
<script>
    $('#content').summernote({
        placeholder: '글을 쓰세요.',
        height: 500,

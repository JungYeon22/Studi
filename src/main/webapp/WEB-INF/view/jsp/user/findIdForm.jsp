...
<div class="container">
    <div class="input-form-background row">
        ...
        <div class="input-form col-md-12 mx-auto">
            ...
            <%--  로그인 성공시 해당 url로 이동 --%>
            <form class="findIdForm" action="${pageContext.request.contextPath}/user/findIdForm" method="post" novalidate>
                <div class="mb-3">
                ...
                <div class="d-grid gap-2">
                    <button class="btn btn-outline-dark" type="submit" id="findIdBtn">아이디 찾기</button>
                </div>
            </form>
